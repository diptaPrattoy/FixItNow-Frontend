...
export function ServiceSearch() {
  ...
  return (
    ...
    >
      {/* Service Search */}
      <label className="flex min-w-0 items-center gap-3 rounded-xl border border-slate-200 bg-slate-50/70 px-3 py-2.5 transition-all hover:border-slate-300 focus-within:border-emerald-300 focus-within:bg-white focus-within:ring-2 focus-within:ring-emerald-100">
        <span
          className="grid size-9 shrink-0 place-items-center rounded-lg bg-emerald-100 text-emerald-700"
          aria-hidden="true"
        >
          <svg
            viewBox="0 0 24 24"
