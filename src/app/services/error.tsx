...
export default function ServicesError({ reset }: { reset: () => void }) {
  return (
    <div className="mx-auto max-w-2xl px-4 py-24 text-center sm:px-6">
      ...
      <h1 className="mt-3 text-3xl font-bold text-slate-950">The services page hit an unexpected error.</h1>
      <p className="mt-4 text-slate-600">Try the request again. If the issue continues, confirm that the backend is online.</p>
